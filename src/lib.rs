...
pub fn bench_proof(
    ...
    let trace_height = 1 << log_trace_length;

    let num_hashes = match objective {
        ProofOptions::Blake3Permutations => {
            println!("Proving 2^{} Blake-3 permutations", { log_trace_length });
            trace_height
        }
        ProofOptions::Poseidon2Permutations => {
            println!("Proving 2^{} native Poseidon-2 permutations", {
                log_trace_length + P2_LOG_VECTOR_LEN
            });
    ...
    match field {
        FieldOptions::KoalaBear => {
            ...
            let proof_goal = match objective {
            ...
            let dft = match discrete_fourier_transform {
        ...
        FieldOptions::Mersenne31 => {
            ...
            match discrete_fourier_transform {
                DftOptions::None => {}
                _ => panic!(
